...
\title{A Pregel Based MultiThread Graph Processing Library}
...
\begin{abstract}
  ...
  The emerging applications in big data science and social networks has led to the development of numerous parallel or distributed graph processing applications. The need for faster manipulation of graphs has driven the need to scale to 
